...
BATCH_SIZE = 512
SEQUENCE_LENGTH, INPUT_SIZE, HIDDEN_SIZE = models_LSTM.LSTM_shallow.return_train_data()
...
model = models_LSTM.LSTM_shallow(INPUT_SIZE, hidden_units=HIDDEN_SIZE, seq_length=SEQUENCE_LENGTH).to(device)
